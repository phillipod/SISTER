...
class Screenshot(db.Model):
    ...
    data = db.Column(mysql.LONGBLOB().with_variant(LargeBinary(), 'sqlite'), nullable=True)
    thumbnail_data = db.Column(mysql.LONGBLOB().with_variant(LargeBinary(), 'sqlite'), nullable=True)
