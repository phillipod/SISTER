...
def main():
    parser = argparse.ArgumentParser(description="Run label detection and region detection on SISTER test screenshots.")
    ...
    parser.add_argument("--output-dir", default="output/region_detector", help="Directory to save debug output images.")
    ...
    for image_name, expected_type in sample_images.items():
        ...
        try:
            ...
            region_data = {}
            if detected_type == "PC Ship Build" or detected_type == "PC Ground Build" or detected_type == "Console Ship Build" or detected_type == "Console Ground Build":
                import cv2
